...
function PanelStudyBrowser({
  ...
  function updateSopInstanceUIDInUrl(sopInstanceUID) {
    const currentUrl = new URL(window.location.href);
    currentUrl.searchParams.set('sopInstanceUID', sopInstanceUID);
  ...
  //     console.log('Fetched displaySet:', displaySet);

  //     // Check for instances array
  //     if (!displaySet.instances || displaySet.instances.length === 0) {
  //       console.warn('No instances found for display set:', displaySetInstanceUID);
  //       return;
  //     }

  //     // Get the SOPInstanceUID from the first instance
  //     const sopInstanceUID = displaySet.instances[0]?.SOPInstanceUID;

  //     // Update URL with SOPInstanceUID
  //     updateSopInstanceUIDInUrl(sopInstanceUID);

  //     // Load the image in the viewer
  //     const imageId = displaySet.imageIds[0];
  //     if (imageId && activeViewportId) {
  //       commandsManager.runCommand('setViewportData', {
  ...
  //     // Trigger custom single-click callback if defined
  ...
  //         await handler(displaySetInstanceUID, sopInstanceUID);
  //       }
  //     }
  //   },
  //   [
  ...
  //     extensionManager,
  //     updateSopInstanceUIDInUrl,
  //   ]
  // );

  // Handle thumbnail double-click (as provided)
  ...
  //   if (!firstDS || !firstDS.instances || firstDS.instances.length === 0) {
  //     return;
  //   }
  //   const sopInstanceUID = firstDS.instances[0]?.SOPInstanceUID;
  //   if (sopInstanceUID) {
  //     updateSopInstanceUIDInUrl(sopInstanceUID);
  //     const imageId = firstDS.imageIds?.[0];
  //     if (imageId && activeViewportId) {
  //       commandsManager.runCommand('setViewportData', {
  //         viewportId: activeViewportId,
  //         displaySetInstanceUID: firstDS.displaySetInstanceUID,
  //         imageId,
  //       });
  //     }
  //   }
